...
from nn.misc import random_weight_matrix
...
# shallow neural network model for NER, going deep will slowing down training, just can not wait several hours
# to train a model.. easy to stack more layers using libraries like keras, theano, torch, caffe and etc.
# --some papers said that NLP temporarily tend to use relatively shallow ones?
class WindowMLP(NNBase):
    ...
    def _acc_grads(self, window, label):
        ...
        Update self.grads and self.sgrads in order for gradient_check and training to work.

        e.g.:
        self.grads.U += (gradient dJ/dU)
        ...
        # Compute gradients w.r.t cross-entropy loss, softmax-activation layer
